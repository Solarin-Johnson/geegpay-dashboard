export const DashboardIcon = ({ i, active, setActiveMenu }) => {
  const color = "var(--menu-color)";
  return (
    <svg
...
export const MenuIcon2 = ({ i, active, setActiveMenu }) => {
  const color = `${
    i === active ? "var(--menu-color)" : "var(--menu-color-alt)"
  }`;
  console.log(color);
  return (
    <svg
...
export const MenuIcon3 = ({ i, active, setActiveMenu }) => {
  const color = `${
    i === active ? "var(--menu-color)" : "var(--menu-color-alt)"
  }`;
  return (
...
export const MenuIcon4 = ({ i, active, setActiveMenu }) => {
  const color = `${
    i === active ? "var(--menu-color)" : "var(--menu-color-alt)"
  }`;
  return (
...
export const MenuIcon5 = ({ i, active, setActiveMenu }) => {
  const color = `${
    i === active ? "var(--menu-color)" : "var(--menu-color-alt)"
  }`;
  return (
...
export const MenuIcon6 = ({ i, active, setActiveMenu }) => {
  const color = `${
    i === active ? "var(--menu-color)" : "var(--menu-color-alt)"
  }`;
  return (
...
export const MenuIcon7 = ({ i, active, setActiveMenu }) => {
  const color = `${
    i === active ? "var(--menu-color)" : "var(--menu-color-alt)"
  }`;
  return (
...
export const MenuIcon8 = ({ i, active, setActiveMenu }) => {
  const color = `${
    i === active ? "var(--menu-color)" : "var(--menu-color-alt)"
  }`;
  return (
...
export const MenuIcon9 = ({ i, active, setActiveMenu }) => {
  const color = `${
    i === active ? "var(--menu-color)" : "var(--menu-color-alt)"
  }`;
  return (
...
export const ModeIconDark = ({ mode, setMode }) => {
  const color = `${
    mode === "dark" ? "var(--accent)" : "var(--menu-color-alt)"
  }`;
  return (
    <svg
...
export const ModeIconLight = ({ mode, setMode }) => {
  const color = `${
    mode === "light" ? "var(--accent)" : "var(--menu-color-alt)"
  }`;
  return (
    <svg
